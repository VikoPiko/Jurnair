...
const JournalCard = ({ entry }: { entry: JournalType }) => {
  const MAX_LENGTH = 90;
  const safeDescription = entry.entryContent ?? "";
  ...
  return (
    <div className="border hover:shadow-lg rounded-lg p-4 col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-2 transition-all duration-200 cursor-pointer bg-white dark:bg-[#484848]/50 h-[250px] flex flex-col">
